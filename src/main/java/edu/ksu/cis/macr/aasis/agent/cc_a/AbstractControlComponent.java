...
import edu.ksu.cis.macr.aasis.agent.cc_a.comm.InternalOrganizationCommunicationCapability;
...
/**
 Class common to all control components, regardless of application domain.
...
public abstract class AbstractControlComponent implements IAbstractControlComponent {
    ...
    protected UniqueIdentifier localMaster = null;
    protected IPersona owner = null;

    protected IInternalOrganizationCommunicationCapability internalOrganizationCommunicationCapability;
    ...
    protected AbstractControlComponent(final String name, final IPersona owner, final Element organization,
        ...
        this.internalOrganizationCommunicationCapability = new InternalOrganizationCommunicationCapability(owner);
        LOG.info("Created internalOrganizationCommunicationCapability for control component of person {}.", name);
     ...
     */
    @Override
    public synchronized void setReorganizationAlgorithm(final IReorganizationAlgorithm reorganizationAlgorithm) {

 ...
 *
 */
package edu.ksu.cis.macr.aasis.agent.guidelines;
...
public class AgentGuidelines implements Serializable, IAgentGuidelines {
  ...
  @Override
  public void setConstantInelasticLoad_fraction(double constantInelasticLoad_fraction) {
  ...
  @Override
  public void setMaxVoltageMultiplier(double maxVoltageMultiplier) {
  ...
  @Override
  public void setConstantInelasticLoad_kw(double constantInelasticLoad_kw) {
  ...
  @Override
  public void setNetDeltaP(double netDeltaP) {

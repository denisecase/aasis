 ...
 *
 */
public class SimulatorTableModel extends AbstractTableModel {
    private static final Logger LOG = LoggerFactory.getLogger(SimulatorTableModel.class);
    ...
    public SimulatorTableModel() {
    }

    public SimulatorTableModel(ArrayList<IRead<?>> inputData) {
    ...
    /*
     * Not editable yet - kept though in case we want to add.
     */
    @Override
    ...
    public Object getValueAt(int row, int col) {
        ...
        if (col == 1) {
            ...
            IRead r = (IRead) reading.getSensorReadObject();
            Object d = r.getSensorReadObject();
            int iColArray = col - 2;
            return iColArray;  // provides dummy data
//      switch (iColArray) {
//        case 0:
